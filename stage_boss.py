...
def init():
    ...
    game_world.add_collision_pair('monster_boss_left:player', None, common.player)
    game_world.add_collision_pair('monster_boss_right:player', None, common.player)
    ...
    game_world.add_collision_pair('monster_boss:player', common.monster_boss, None)

    common.monster_boss_left_hand = Monster_boss_left_hand()
    game_world.add_object(common.monster_boss_left_hand, 2)
    game_world.add_collision_pair('monster_boss_left:player', common.monster_boss_left_hand, None)
    game_world.add_collision_pair('monster:sword', common.monster_boss_left_hand, None)

    common.monster_boss_right_hand = Monster_boss_right_hand()
    game_world.add_object(common.monster_boss_right_hand, 2)
    game_world.add_collision_pair('monster_boss_right:player', common.monster_boss_right_hand, None)
    game_world.add_collision_pair('monster:sword', common.monster_boss_right_hand, None)
